...
export default function ConnectModal({ login, open, onClose }) {
  return (
    <Dialog onClose={onClose} open={open}>
      <DialogTitle sx={{ m: 0, p: 2, color: 'white', background: '#010101' }}>
      ...
      <DialogContent dividers sx={{ p: 1, background: '#010101', width:'250px' }}>
        <Stack direction="row" justifyContent="center" alignItems="center" flexWrap="wrap" sx={{ maxWidth: 350 }}>
